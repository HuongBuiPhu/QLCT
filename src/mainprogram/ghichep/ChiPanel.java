...
public class ChiPanel extends javax.swing.JPanel {
    ...
    Program program;
    Process process;
    String sql = "select Ten from hangmucchi";

    SimpleDateFormat form1 = new SimpleDateFormat("yyyy-MM-dd");
    SimpleDateFormat form2 = new SimpleDateFormat("HH:mm");

    public ChiPanel(Program program) {
        initComponents();
    ...
    private void saveButMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_saveButMouseClicked
        ...
        String id = process.getHangMucChiId(process.getHangMucChiId(hangMucCb.getSelectedItem().toString()));
        process.ghiChep("chi", tienTf.getText().trim(), ng, gi, id, dienGiaiTf.getText().trim(), program.maThanhVien);
    ...
    private void hangMucCbItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_hangMucCbItemStateChanged
        ...
        if (hangMucCb.getSelectedItem() == "Khác") {
            ...
            program.hangMuc.isChiTien = true;
